...
2. **Screen Recording** — lets JazzHands capture window thumbnails for Fingers. Same path but under **Screen Recording**.
...
- **Behavior** — hover delay, cursor sensitivity, dead zone, fingers toggle
- **Animation** — parent wedge slide on fingers entry
